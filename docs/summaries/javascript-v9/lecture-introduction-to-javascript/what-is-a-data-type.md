# Introduction to JavaScript - What Is a Data Type, and What Are the Different Data Types in JavaScript? | Learn | freeCodeCamp.org

> Source: https://www.freecodecamp.org/learn/javascript-v9/lecture-introduction-to-javascript/what-is-a-data-type · Saved 8/24/2026, 5:03:51 PM
...
// Examples of integers console.log(3); console.log(5); console.log(-67);

A floating point number is a number with a decimal point. Examples of floating point numbers include 3.14 and 5.2.

// Examples of floating point numbers console.log(3.14); console.log(7.2); console.log(-14.5);
...
- A data type is the kind of value stored, and a variable is a named container for a value of a specific type.
- JavaScript basic types introduced:
  - Number: integers and floating-point numbers, e.g., 7, -67, 3.14
  - String: sequence of characters in quotes, e.g., "I love to code!"
  - Boolean: true or false
  - undefined: declared variable with no value yet
  - null: intentionally set to "nothing"
  - Object: collection of key-value pairs, e.g., { name: "Alice", age: 30 }
  - Symbol: unique, immutable identifier
  - BigInt: very large integers with trailing `n`

## What the MCQs are asking
- Which of the following is a string data type? Tests recognition of text enclosed in quotes vs other types.
- What data type represents a value that is either true or false? Tests identification of Boolean.
- If a variable has been declared but not assigned a value, what is its data type? Tests identification of undefined.

## What it means
- String question means distinguishing text values from numbers/booleans; quotes are the key signal.
- Boolean question means understanding true/false as a logical type used for conditions like logged in/not logged in.
- Undefined question means knowing the default state of a declared-but-uninitialized variable before assignment.

## Most important things to know
- Data types tell the program how to handle a value.
- Number covers both integers and decimals; BigInt is for numbers beyond Number limits.
- String must be in single or double quotes.
- Boolean is only true/false.
- undefined is automatic for unassigned variables; null is intentional empty.
- Object groups related data; Symbol and BigInt are advanced/less common.
